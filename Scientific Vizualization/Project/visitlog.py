# Visit 3.3.2 log file
ScriptVersion = "3.3.2"
if ScriptVersion != Version():
    print "This script is for VisIt %s. It may not work with version %s" % (ScriptVersion, Version())
ShowAllWindows()
Source("/usr/common/visit3_3_2.linux-x86_64-wmesa/3.3.2/linux-x86_64/bin/makemovie.py")
...
SaveWindowAtts.outputDirectory = "/home/amk23j/Documents/FSU-assignments/Scientific Vizualization/Project/reflec_pres/movie-0"
SaveWindowAtts.fileName = "movie0000"
SaveWindowAtts.family = 0
SaveWindowAtts.format = SaveWindowAtts.PNG  # BMP, CURVE, JPEG, OBJ, PNG, POSTSCRIPT, POVRAY, PPM, RGB, STL, TIFF, ULTRA, VTK, PLY, EXR
SaveWindowAtts.width = 1920
SaveWindowAtts.height = 1072
...
SaveSession("/home/amk23j/.visit/crash_recovery.162824.session")
# MAINTENANCE ISSUE: SetSuppressMessagesRPC is not handled in Logging.C. Please contact a VisIt developer.
# MAINTENANCE ISSUE: SetSuppressMessagesRPC is not handled in Logging.C. Please contact a VisIt developer.
SaveSession("/h