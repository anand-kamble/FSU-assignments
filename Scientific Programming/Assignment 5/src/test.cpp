...
int main()
{
    ...
    const char *SurroundingAreaFileName = "Surrounding_areas_test.txt";
    const char *EdgeLengthFileName = "edge_lengths_test.txt";

    cout << "Running the Tests." << endl;
    auto TestClass = new BrainMesh("Test", true);
