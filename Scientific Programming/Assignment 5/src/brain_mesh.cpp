...
BrainMesh::BrainMesh(const string &id, bool debugMode)
{
    ...
    // this->points;                 // Vector containing all vertices in the format [X, Y, Z].
    // this->polygons;                 // Vector containing polygons, where each polygon includes indices of vertices that make up the polygon.
